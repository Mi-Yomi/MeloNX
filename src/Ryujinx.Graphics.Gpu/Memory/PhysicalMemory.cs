...
namespace Ryujinx.Graphics.Gpu.Memory
{
    ...
    class PhysicalMemory : IDisposable
    {
        ...
        internal (
            ...
            ulong TextureNormalEvictions,
            ulong TextureNormalEvictedBytes,
            ulong TextureNormalReadbackEvictions,
            ulong TextureNormalCleanBypasses,
            int TextureEvicted,
            ...
            ulong availableMemoryBytes)
        {
            ...
            ulong bufferTarget = MemoryPressureTrimPolicy.CalculateBufferTarget(BufferCache.Capacity, severity, availableMemoryBytes);
            ...
            bufferTarget = Math.Min(bufferTarget, BufferCache.EffectiveCapacity);
            ...
            return (
                ...
                textureStatistics.NormalEvictions,
                textureStatistics.NormalEvictedBytes,
                textureStatistics.NormalReadbackEvictions,
                textureStatistics.NormalCleanBypasses,
                0,
                0,
                0,
                textureBefore,
